...
#define CONFIGURE_ARGS " '--prefix=/home/ning/postgresql-17.4' '--enable-debug' 'CFLAGS=-O0'"
...
#define PG_VERSION_STR "PostgreSQL 17.4 on x86_64-pc-linux-gnu, compiled by gcc (Ubuntu 11.4.0-1ubuntu1~22.04.2) 11.4.0, 64-bit"
